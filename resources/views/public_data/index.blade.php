                    ...
                    <div class="col-lg-12 d-flex">
                        <div class="col-lg-8">
                            <main class="content">
                                ...
                                <p><b>BaseUrl:</b> GET https://academicreport.seu.edu.sa/api</p>
                                <button class="btn btn-primary" onclick="showData()">GET All</button>

                                <h3 id="get-by-semester">2. Retrieve Graduated Student by Faculties</h3>
                                <p><b>Endpoint:</b> GET /graduated/statistics?faculty_id[]=1&faculty_id[]=2</p>
                                <button class="btn btn-primary" onclick="showData('faculty', 1)">GET
                                    By Faculties
                                </button>

                                <h3 id="get-by-degree">3. Retrieve Graduates by Year</h3>
                                <p><b>Endpoint:</b> GET /graduated/statistics?year_id[]=1&year_id[]=4</p>
                                <button class="btn btn-primary" onclick="showData('year', 1)">GET
                                    By Year(s)
                                </button>

                                <h3 id="get-by-gender">4. Retrieve Graduates by Gender</h3>
                                <p><b>Endpoint:</b> GET /api/graduated/statistics?gender[]=male&?gender[]=female</p>
